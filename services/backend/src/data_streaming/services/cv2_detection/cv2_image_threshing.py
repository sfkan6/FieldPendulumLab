...
class CV2Thresher(Thresher):
    ...
    def __init__(self, open_iters: int=1, dilate_iters: int=2, close_iters: int=2):
...
class CV2HSVThresher(CV2Thresher, HSVThresher):
    ...
    def __init__(self, hsv_ranges: list|tuple|MatLike, open_iters: int=3, dilate_iters: int=4, close_iters: int=3):
    ...
    def set_hsv_ranges(self, hsv_ranges: list|tuple|MatLike) -> None:
